<template>
  <StockTickerList
    v-bind:stockTickers='stockTickers'
...
const stockTickersModule = namespace('stockTickers');
...
export default class StockTickers extends Vue {
  @stockTickersModule.State('stockTickers')
  private stockTickers!: StockTickerViewModel[];
  @stockTickersModule.Action('loadStockTickers')
  private loadStockTickers!: () => void;
